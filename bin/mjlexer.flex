...
"+="		{ return new_symbol(sym.ASSADD, yytext()); }
"-="		{ return new_symbol(sym.ASSSUB, yytext()); }
"*="		{ return new_symbol(sym.ASSMUL, yytext()); }
"/="		{ return new_symbol(sym.ASSDIV, yytext()); }
"%="		{ return new_symbol(sym.ASSMOD, yytext()); }

";" 		{ return new_symbol(sym.SEMI, yytext()); }
"," 		{ return new_symbol(sym.COMMA, yytext()); }
"." 		{ return new_symbol(sym.PT, yytext()); }
